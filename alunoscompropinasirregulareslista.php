...
$painellogado=$_SESSION['painel'];
 ...
 $nome_da_turma=$dados_da_turma["titulo"];
...
include("cabecalho.php") ; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Alunos com propinas Em Atraso no ano lectivo <a href="anolectivo.php?idanolectivo=<?php echo "$idanolectivo"; ?>"><?php echo "$nomedoanolectivo"; ?></a> <?php  echo " ( $mesescolhido/$anoescolhido )"; ?> | <a href="turma.php?idturma=<?php echo "$idturma"; ?>"><?php echo "$nome_da_turma"; ?></a></h1>
    ...
    <button id="myBtn" class="btn btn-success">  <i class="fas fa-fw fa-calendar"></i> Escolher um Mês específico</button>
     ...
     <a href="pdf/propinasematrasotodos.php?idturma=<?php echo $idturma; ?>&anodevenda=<?php echo $anoescolhido; ?>&mesdevenda=<?php echo $mesescolhido; ?>"><button class="btn btn-info">  <i class="fas fa-fw fa-print"></i>Imprimir Lista</button></a>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
               ...
               <a href="alunoscompropinasirregulares.php?idanolectivo=<?php echo "$idanolectivo"; ?>"   class="d-sm-inline-block btn btn-sm btn-info"><i class="fas fa-fw fa-user"></i>Ver todos os alunos </a>   


               <a href="alunoscompropinasirregularesturmas.php?idanolectivo=<?php echo "$idanolectivo"; ?>"  class="d-sm-inline-block btn btn-sm btn-primary"><i class="fas fa-fw fa-users"></i>Agrupar Por Turmas</a>  <br><br>
<br><br>
           ...
           <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php
                        ...
                        $lista=mysqli_query($conexao, "SELECT alunos.nomecompleto, YEAR(matriculaseconfirmacoes.ultimomespago) as ano, MONTH(matriculaseconfirmacoes.ultimomespago) as mes, matriculaseconfirmacoes.* from matriculaseconfirmacoes, alunos where matriculaseconfirmacoes.idaluno=alunos.idaluno and matriculaseconfirmacoes.idanolectivo='$idanolectivo' and (ultimomespago<'$mes_em_questao' and tipodealuno!='Bolseiro') and  idturma='$idturma'"); 
