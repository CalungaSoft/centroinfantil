...
$idmatriculatransporte=isset($_POST['id'])?$_POST['id']:"";
$idmatriculatransporte=mysqli_escape_string($conexao, $idmatriculatransporte); 

   $dadoslectivos_confirmacao=mysqli_fetch_array(mysqli_query($conexao, "SELECT YEAR(matriculatransporte.ultimomespago) as ano, MONTH(matriculatransporte.ultimomespago) as mes, matriculatransporte.* from matriculatransporte where idmatriculatransporte='$idmatriculatransporte' limit 1"));
    ...
    $Dados_do_aluno=mysqli_fetch_array(mysqli_query($conexao, "select * from alunos where idaluno='$idaluno' order by idaluno desc limit 1"));
       ...
       $preco_da_propina=mysqli_fetch_array(mysqli_query($conexao, "select propina from transportes where idtransporte='$idtransporte' limit 1"))[0];
...
$numero_de_meses_pagos=mysqli_num_rows(mysqli_query($conexao, "select * from propinasdotransporte where idmatriculatransporte='$idmatriculatransporte'"));
...
$html="";
    ...
    Pagar Propina do Aluno <h2>'.$nomecompleto.'</h2>
       ...
       <div class="alert alert-info">
             ...
             Ano Lectivo: <strong>'.$titulo_do_ano_lectivo.'</strong> | Transporte: <strong>'.$dadoslectivos_confirmacao["transporte"].'  </strong> <br>
           ...
           <h4>Último mês pago: <strong> '.$ultimopagamento.' </strong></h4> <br>
 				   ...
 				   <div class="form-group"> 
                     ...
                     <input type="hidden" name="idmatriculatransporte"    value='.$idmatriculatransporte.'>
