                     ...
                     <th >Disciplina</th>
                         ...
                         while($exibir = $lista->fetch_array()){ 
                              ...
                              $iddisciplina=$exibir["iddisciplina"];
                               ...
                               $numeromaiordeavaliacao=mysqli_fetch_array(mysqli_query($conexao, "SELECT count(idavaliacao) from avaliacoes where iddisciplina='$iddisciplina' and idtrimestre='$idtrimestre' "))[0];
