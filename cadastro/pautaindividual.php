...
<tr>  
 <td> <a  href="disciplina.php?iddisciplina='.$exibir["iddisciplina"].'">'.$exibir['titulo'].' </a></td>'; 
                 ...
                 while($observar = $listadetrimestre->fetch_array()){
                     ...
                     $listademeiamaior=mysqli_query($conexao, "select * from mediasdoano where idanolectivo='$idanolectivo' and  tipodeturma='exame' and tipodemedia='demedias' and percentagem!=0 and idtrimestre='$idtrimestre'  ");
