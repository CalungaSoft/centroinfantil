                      ...
                      <div class="col-sm-3">   
                        ...
                        <span>Tipo de Disciplina</span>
                                  <select name="tipodedisciplina" required  class="form-control">
                                    <option value="Normal" '; if($tipodedisciplina=="Normal") { $htm.='selected="" '; } $htm.='>Normal</option> 
                                    <option value="Chave" '; if($tipodedisciplina=="Chave") { $htm.='selected="" '; } $htm.='>Chave</option> 
                                  </select> 
                        </div> 
                         ...
                         <div class="col-sm-5">  
                          ...
                          <select name="agrupamento" required  class="form-control">
                            <option value="Formação Geral" '; if($agrupamento=="Formação Geral") { $htm.='selected="" '; } $htm.='>Formação Geral</option> 
                            <option value="Formação Específica" '; if($agrupamento=="Formação Específica") { $htm.='selected="" '; } $htm.='>Formação Específica</option> 
                             <option value="Opção" '; if($agrupamento=="Opção") { $htm.='selected="" '; } $htm.='>Opção</option> 
                          </select> 
                        </div> 
