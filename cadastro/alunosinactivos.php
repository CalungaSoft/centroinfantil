...
$idanolectivo=mysqli_escape_string($conexao, trim($_POST['idanolectivo'])); 
 ...
 $htm='
                ...
                <h2>Alunos Inactivos   <a href="pdf/pdfalunosinactivos.php?idanolectivo='.$idanolectivo.'" class="d-sm-inline-block btn btn-sm btn-info" ><i class="fas fa-fw fa-print"></i> Imprimir </a>  </h2> 
