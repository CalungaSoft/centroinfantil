...
$idactividade=$_POST['idactividade'];
 ...
 $htm='
   ...
   <span>Descrição</span>
         <input type="text" disabled="" name="datadamatricula" autocomplete="off" class="form-control "  value="'.$descricao.'">
            ...
            <input type="hidden" name="idactividade" value="'.$idactividade.'"  >
            ...
            <span>Tipo de Aluno</span>
                 ...
                 <div class="form-group">
                    <span>Desconto Padrão nas Mensalidades</span>
                         <input type="number"   name="descontoparapropinas"   min="0"  class="form-control " value="0" placeholder="Desconto no pagamento de Mensalidade" > 
                    </div> 
