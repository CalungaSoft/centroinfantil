...
$idanolectivo=mysqli_escape_string($conexao, trim($_POST['idanolectivo'])); 
 ...
 $htm='
                ...
                <h2>Alunos Com Propinas Pagas   <a href="pdf/pdfalunoscompropinaspagas.php?idanolectivo='.$idanolectivo.'" class="d-sm-inline-block btn btn-sm btn-info" ><i class="fas fa-fw fa-print"></i> Imprimir </a>  </h2> 
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                for ($i=$mesinicio_anolectivo; $i <=12 ; $i++) { 
                                    ...
                                    $ano=$anoinicio_anolectivo;
                                      ...
                                      $data_de_propina_formada="$ano-$mes-01"; // 2021-08-01
                                              ...
                                              $numerodealunos=mysqli_num_rows( mysqli_query($conexao,"SELECT idmatriculaeconfirmacao  from matriculaseconfirmacoes where   idanolectivo='$idanolectivo' and   data<='$data_de_cadastro_formada' and estatus='activo' and (ultimomespago>='$data_de_propina_formada' or tipodealuno='Bolseiro') and matriculaseconfirmacoes.idturma='$idturma'"));
                 ...
                 $contador_exame=0;
                                for ($i=$mesinicio_anolectivo; $i <=12 ; $i++) { 
                                   ...
                                   $numerodealunos=mysqli_num_rows( mysqli_query($conexao,"SELECT idmatriculaeconfirmacao  from matriculaseconfirmacoes, turmas where  matriculaseconfirmacoes.idturma=turmas.idturma and  matriculaseconfirmacoes.idanolectivo='$idanolectivo' and   matriculaseconfirmacoes.data<='$data_de_cadastro_formada' and matriculaseconfirmacoes.estatus='activo' and (ultimomespago>='$data_de_propina_formada' or tipodealuno='Bolseiro') and idciclo='$idciclo'"));
