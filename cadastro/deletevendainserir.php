   ...
   $id=mysqli_escape_string($conexao, $_POST['id']);
        ...
        $dados=mysqli_fetch_array(mysqli_query($conexao," SELECT * FROM entradas where identrada='$id'"));
          ...
          $idtipo=$dados["idtipo"];
           ...
           $antigo="Todos os dados de($descricaonaentrada) | Valor: $valorantigoh KZ | Por Consolidar $dividaantigo KZ";
           $novo="Eliminado";
        ...
        if(mysqli_query($conexao, "Delete from entradas where idtipo='$idtipo' and tipo='$tipo'")){
            echo '<div class="alert alert-success"> Registro Eliminado com Sucesso <a href="index.php">Clique aqui para a página inicial!</a> </div>';
       }
       else{
