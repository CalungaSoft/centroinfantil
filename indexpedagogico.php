 ...
 ?>
    ...
    <!-- Content Row -->
          ...
          <a href="relatoriodiario.php?idanolectivo=<?php echo $anolectivo_cabecalho['idanolectivo']; ?>&diadevenda=<?php echo "$dia_escolhido"; ?>&mesdevenda=<?php echo "$mes_escolhido"; ?>&anodevenda=<?php echo "$ano_escolhido"; ?>">
            ...
            <!-- Earnings (Monthly) Card Example -->
            <div class="col-xl-3 col-md-6 mb-3">
            <a href="disciplinasareapedagogicaindividual.php?idanolectivo=<?php echo $anolectivo_cabecalho['idanolectivo']; ?>&funcao=Lançar Presença">
              <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Lançar Presença</div>
