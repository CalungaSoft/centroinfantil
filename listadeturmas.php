      ...
      $idcoordenador=mysqli_escape_string($conexao,$_POST['idcoordenador']);
        ...
        $existe=mysqli_num_rows(mysqli_query($conexao, "select idturma from turmas where titulo='$titulo' and idanolectivo='$idanolectivo' "));
          ...
          if($existe==0){
                ...
                $salvar= mysqli_query($conexao,"INSERT INTO `turmas` (titulo, idanolectivo, idperiodo, idsala, idciclo, matricula, reconfirmacao, propina, idcoordenador) VALUES ('$titulo', '$idanolectivo', '$idperiodo', '$idsala', '$idciclo', '$matricula', '$reconfirmacao', '$propina', '$idcoordenador')");
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  ?>
                    <tr>  
                      ...
                      <td><a  href="ciclo.php?idciclo=<?php echo $exibir["idciclo"]; ?>"><?php echo $ciclo; ?></a></td>  
                      ...
                      <td align="center" title="Veja mais opções sobre esse turma">
                         <a  href="turma.php?idturma=<?php echo $exibir["idturma"]; ?>" <?php echo $exibir["idturma"]; ?>><i  class="fas fa-eye" ></i> </a>
                      </td>
                    </tr> 
                    <?php } ?> 
                  </tbody>
