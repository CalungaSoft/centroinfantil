...
include("cabecalho.php") ; ?>
 ...
 <?php
  ...
  echo '<a href="relatoriodiario.php?idanolectivo='.$idanolectivo.'&idturma='.$idturma.'" class="d-sm-inline-block btn btn-sm btn-primary" ><i class="fas fa-fw fa-user"></i> Lançar Relatórios </a> ';
                ...
                <h3>Escolha uma Turma e Trimestre</h3> <br> 
                 ...
                 <span>Escolha a Turma</span>
                    <select name="idturma" required  class="form-control"> 
                      <?php
                           $lista=mysqli_query($conexao,"SELECT turmas.idturma, turmas.titulo from turmas where turmas.idanolectivo='$idanolectivo' order by titulo desc");
            ...
            <div class="card-body">
              ...
              <div class="alert alert-info">Se desejar editar um relatório pode o fazer clicando direitamente no compo do registro. <br> ATT: só pode editar ou eliminar relatório de aluno lançados por ti.</div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                  <?php
                        $lista=mysqli_query($conexao, "SELECT    matriculaseconfirmacoes.classe,matriculaseconfirmacoes.estatus, relatoriodiario.* from relatoriodiario, matriculaseconfirmacoes, turmas where matriculaseconfirmacoes.idturma=turmas.idturma and relatoriodiario.idmatriculaeconfirmacao=matriculaseconfirmacoes.idmatriculaeconfirmacao and turmas.idturma='$idturma' order by data desc"); 
                        $n=0;
                         while($exibir = $lista->fetch_array()){
