             ...
             if($zerando_dividas){
                ...
                $salvar_financas=mysqli_query($conexao,"INSERT INTO `entradas` (`identrada`, `idfuncionario`, `descricao`, `tipo`, `idtipo`, `valor`, `divida`, `idaluno`, `idturma`, `datadaentrada`, formadepagamento, idanolectivo) VALUES (NULL, '$idlogado', '$descricao', '$tipo','$idtipo', '$valor', '$nova_divida', '$idaluno', '0', CURRENT_TIMESTAMP, '$formadepagamento', '$idanolectivo')");
                      ...
                      if($salvar_financas){
                        ...
                        $dados_do_pagamento=mysqli_fetch_array(mysqli_query($conexao," SELECT sum(divida) as totaldivida, sum(valor) as totalpago FROM entradas where tipo='$tipo' and idtipo='$idtipo'"));

                          $totalpago=$dados_do_pagamento['totalpago'];
                        
                          $actualizandopagamentos=mysqli_query($conexao,"UPDATE `matriculatransporte` SET `valorpago` = '$totalpago' WHERE `matriculatransporte`.`idmatriculatransporte` = '$idtipo'");
...
if(isset($_POST['editaralteracoes'])){
    ...
    $datadaentrada=mysqli_escape_string($conexao, trim($_POST['datadaentrada']) );  
                ...
                $novo="($descricao) | Pago: $valor  | F. Pag: $formadepagamento | $datadaentrada <a href=entradadamatriculadotransporte.php?identrada=$identrada>Clique para ver</a>";
            ...
            if($guardar2){
               ...
               $actualizando=mysqli_query($conexao, "UPDATE `entradas` SET `datadaentrada` = '$datadaentrada', `descricao` = '$descricao', `valor` = '$valor', `formadepagamento` = '$formadepagamento' WHERE identrada = '$identrada'");
                  ...
                  $zerando_dividas=mysqli_query($conexao,"UPDATE `entradas` SET  `divida` ='0' WHERE tipo='$tipo' and idtipo='$idtipo'");
                   ...
                   $preco=mysqli_fetch_array(mysqli_query($conexao," SELECT sum(preco-desconto) as preco FROM matriculatransporte where idmatriculatransporte='$idtipo' "))['preco'];
                   ...
                   $actualizando_nasmatriculas=mysqli_query($conexao,"UPDATE `matriculatransporte` SET  `valorpago` ='$valorpago' WHERE   idmatriculatransporte='$idtipo' limit 1");
          ...
          if($nova_divida<0){
              $nova_divida=0;
                          ...
                          if($insirindo_dividas){
                                ...
                                $actualizandopagamentos=mysqli_query($conexao,"UPDATE `matriculatransporte` SET `preco` = '$preco', `desconto` = '$desconto' WHERE `matriculatransporte`.`idmatriculatransporte` = '$idtipo'");
...
if(isset($_POST['editardadoslectivos'])){
    ...
    $transportenovo=mysqli_escape_string($conexao, trim($_POST['transportenovo']));  
    ...
    $obsmatricula=mysqli_escape_string($conexao, trim($_POST['obsmatricula']));   
       ...
       $dadoslectivos= mysqli_fetch_array(mysqli_query($conexao, "select * from transportes where idtransporte='$transportenovo' limit 1")); 

                           $transporte=$dadoslectivos["titulo"];  
                           $idanolectivo=$dadoslectivos["idanolectivo"];

                          


                   $existe=mysqli_num_rows(mysqli_query($conexao, "select idaluno from matriculatransporte where idaluno='$idaluno' and idtransporte='$transportenovo'"));
  
                
                  if($existe==0){

 
                           $salvar=mysqli_query($conexao,"UPDATE matriculatransporte set idtransporte='$transportenovo', tipodealuno='$tipodealuno', data='$datadamatricula', descontoparapropinas='$descontoparapropinas', obs='$obsmatricula', transporte='$transporte'  where idmatriculatransporte='$idtipo'");
                               ...
                               $acerto[]="Alterações feitas com sucesso!";
                                     ...
                                     $erros[]="Ocorreu um erro ao alterar o $tipo do aluno";
                                }
                        }else{

                                     $erros[]="Já existe uma $tipo desse aluno nessa turma";

                                      $salvar=mysqli_query($conexao,"UPDATE matriculatransporte set  tipodealuno='$tipodealuno', data='$datadamatricula', descontoparapropinas='$descontoparapropinas', obs='$obsmatricula' where idmatriculatransporte='$idtipo'");
                               ...
                               $acerto[]="Alterações feitas com sucesso!";
                                     ...
                                     $erros[]="Ocorreu um erro ao alterar o $tipo do aluno";
                                                 ...
                                                 $dadosdamatricula=mysqli_fetch_array(mysqli_query($conexao," SELECT * FROM matriculatransporte where idmatriculatransporte='$idtipo' "));
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
                                           ...
                                            Sexo: <strong> <?php echo $dadosdoaluno["sexo"]; ?> </strong> <br><br><br>

                                            Nome do Pai: <strong> <?php echo $dadosdoaluno["nomedopai"]; ?> </strong> <br><br><br>

                                            Nome da Mãe: <strong> <?php echo $dadosdoaluno["nomedamae"]; ?> </strong> <br><br><br>

                                            Data de Nascimento: <strong> <?php echo $dadosdoaluno["datadenascimento"]; ?> </strong>  
 ...
 Ano Lectivo
                                          <h3><strong> <?php echo $anolectivo["titulo"]; ?> </strong></h3>
                                            ...
                                            <?php
                                              ...
                                              $matriculasdesseano= mysqli_query($conexao, "select * from matriculatransporte where idmatriculatransporte='$idtipo'");

                                              while($exibir = $matriculasdesseano->fetch_array()){

                                                    $transporte=$exibir["transporte"];
                                                    $idtransporte=$exibir["idtransporte"];
                                                    $data_da_matricula=$exibir["data"];
                                                    $tipo_de_aluno=$exibir["tipodealuno"];

                                                    $desconto_nas_propianas=$exibir["descontoparapropinas"];
                                           ...
                                           $dadosdaturma= mysqli_fetch_array(mysqli_query($conexao, "select * from transportes where idtransporte='$idtransporte' limit 1")); 
                                             ...
                                             $valorpago=number_format($exibir["valorpago"],2,",", ".");
                                              ...
                                              $totalcobrado=number_format($exibir["preco"]-$exibir["desconto"],2,",", ".");
                                             ...
                                             $divida=number_format($exibir["preco"]-$exibir["desconto"]-$exibir["valorpago"],2,",", ".");
                                                ...
                                                ?>
                                                  <hr> <hr>
                                                  transporte: <a href="transporte.php?idtransporte=<?php echo $idtransporte; ?>"> <?php echo $transporte; ?> </a> 
                                         ...
                                         <!-- Collapsable Card Example -->
                                              ...
                                              <a href="#collapseCardExample2" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseCardExample2">
                                                <h6 class="m-0 font-weight-bold text-primary">Editar Dados Lectivos</h6>
                                              </a>
                                              ...
                                              <div class="collapse in" id="collapseCardExample2">
                                                ...
                                                <form action="" method="post">
                                                 ...
                                                 <span>transporte</span>
                                                      ...
                                                      <select name="transportenovo"   required  class="form-control">
                                                          <option value="0">Escolha a transporte</option> 
                                                        <?php
                                                             $lista=mysqli_query($conexao,"SELECT transportes.titulo as transporte, transportes.idtransporte, anoslectivos.titulo  as anolectivo from transportes, anoslectivos where transportes.idanolectivo=anoslectivos.idanolectivo  order by transportes.titulo desc");
                                                            while($exibir = $lista->fetch_array()){ ?>
                                                            <option <?php if($exibir["idtransporte"]==$idtransporte){?> selected="" <?php } ?> value="<?php echo $exibir["idtransporte"]; ?>"><?php echo $exibir["transporte"]; ?> | (<?php echo $exibir["anolectivo"]; ?>)</option>
                                                          <?php } ?> 
                                                      </select> 
                                                      </div>
                                                       ...
                                                       <div class="form-group">
                                                        <span>Tipo de Aluno</span>
                                                                <select name="tipodealuno"  class="form-control"   >  
                                                                       <option <?php if($tipo_de_aluno=="Normal"){?> selected="" <?php } ?>  value="Normal">Normal</option>
                                                                       <option <?php if($tipo_de_aluno=="Bolseiro"){?> selected="" <?php } ?>  value="Bolseiro">Bolseiro</option>
                                                                </select> 
                                                       </div>

                                                      <div class="form-group">
                                                       <span>Data da Matrícula</span>
                                                            <input type="text" name="datadamatricula" autocomplete="off" class="form-control " title="Digite data de Matrícula" placeholder="Data da Matrícula" value="<?php echo "$data_da_matricula"; ?>">
                                                        </div>
                                                       

                                                       <div class="form-group">
                                                          <span>Desconto Padrão nas Propinas</span>
                                                               <input type="number"   name="descontoparapropinas"   min="0"  class="form-control " value="0" placeholder="Desconto no pagamento de propinas" value="<?php echo "$desconto_nas_propianas"; ?>"> 
                                                          </div> 
                                                          
                                                        <div class="form-group">
                                                               <span>Observações sobre a Matrícula</span>
                                                              <textarea name="obsmatricula" rows="3" class="form-control " title="Alguma observação?" ><?php echo "$obs_matricula"; ?></textarea>
                                                          </div>


                                                      <div class="form-group">
                                                          <input type="submit" name="editardadoslectivos" value="Guardar Novas Informações" class="btn btn-success">
                                                      </div> 
                                          ...
                                          <!-- Collapsable Card Example -->
                                            ...
                                            <br> <br>
                                                 ...
                                                  Desconto:<strong>  <?php echo $desconto; ?> </strong><br>

                                                 Total Com desconto:<strong>   <?php echo $totalcobrado; ?> </strong><br> <br>

                                                  Valor Pago:<strong>  <?php echo $valorpago; ?> </strong> |

                                                  Dívida:<strong>   <?php echo $divida; ?> </strong><br>                                               <?php 
                                              } 
                                            ?> 
                                              ...
                                              <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseCardExample">
                                                <h6 class="m-0 font-weight-bold text-primary">Editar Preço e Desconto</h6>
                                              </a>
                                              <!-- Card Content - Collapse -->
                                              <div class="collapse in" id="collapseCardExample">
                                                ...
                                                <?php 
                                                 ...
                                                 ?>
                                                      ...
                                                      <div class="form-group">
                                                          <label>Preço</label>
                                                        <input type="number" min='0' name="preco" class="form-control  "  value="<?php echo $preco ; ?>">
                                                      </div> 

                                                      <div class="form-group">
                                                          <label>Desconto</label>
                                                        <input type="number" min='0' name="desconto" class="form-control  "  value="<?php echo $desconto; ?>">
                                                      </div> 
  ...
  <span id="mensagemdealertaunica"></span> 
            ...
            <script>
                                                            ...
                                                            $(document).on("click", ".deletevenda", function(event){
                                                                ...
                                                                if(confirm("Tens certeza que queres eliminar esse registro? Serão eliminados todos os dados financeiros relacionados com esse registro!")){
                                                                    ...
                                                                    $.ajax({
                                                                    url:'cadastro/deletevendamatriculatransporte.php',
                                                                    method:'POST',
                                                                    data:{
                                                                        id:id
                                                                    },
                                                                    success: function(data){
                                                                        $("#mensagemdealertaunica").html(data);
                     ...
                     $(document).on("click", ".delete", function(event){
                                ...
                                if(confirm("Tens certeza que queres eliminar esse registro? Isso não apagará a dívida, pelo contrário só a acrescentará, isso em detrimento do valor pago apagado!")){
                                    $(this).closest('tr').remove(); 
                                    $.ajax({
                                    url:'cadastro/deleteentradamatriculatransporte.php',
                                    method:'POST',
                                    data:{
                                        id
                                    },
