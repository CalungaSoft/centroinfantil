                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php
                        $lista=mysqli_query($conexao, "select alunos.nomecompleto, matriculaseconfirmacoes.* from matriculaseconfirmacoes, alunos where matriculaseconfirmacoes.idaluno=alunos.idaluno and matriculaseconfirmacoes.idturma='$idturma'"); 
                         ...
                         while($exibir = $lista->fetch_array()){
                          ...
                          $idmatrcula=$exibir["idmatriculaeconfirmacao"];
                          
                          $ultimaavaliacao = mysqli_fetch_array(mysqli_query($conexao, "select datadaavaliacao FROM avaliacoesdosalunos where idmatriculaeconfirmacao	='$idmatrcula' order by datadaavaliacao desc limit 1"));


                          if ($ultimaavaliacao) {
                            $ultimaavaliacao = $ultimaavaliacao[0];
                          } else {
                            $ultimaavaliacao = '';
                          }
                  ...
                  ?>
                    <tr>  
                      ...
                      <td><?php echo $ultimaavaliacao; ?></td> 
                      <td><a href="realizaravaliacao.php?idmatricula=<?php echo $idmatrcula; ?>"><button class="btn btn-success" title="Escolher esse aluno para avaliar"><i style="color:green;" class="fas fa-fw fa-check"></i>  Avaliar</button></a></td>
                    </tr> 
                    <?php } ?> 
                  </tbody>
                </table>
