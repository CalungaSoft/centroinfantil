...
include("cabecalho.php") ; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Lista de Alunos </h1> <br>
...
?>
   ...
   <a href="escolheraluno.php?idanolectivo=<?php echo $anolectivo['idanolectivo']; ?>" class="d-sm-inline-block btn btn-sm btn-info shadow-sm"><i class="fas fa-user fa-sm text-white-50"></i> Ver só os alunos matriculados</a>
                    ...
                    <tr >  
                      ...
                      <td><?php echo $exibir['morada']; ?></td> 
                       <td align="center" title="Reconfirmar Matrícula desse aluno">
                         <a  href="reconfirmacao.php?idmatriculaeconfirmacao=0&idaluno=<?php echo $exibir["idaluno"]; ?>"> <button class="btn btn-success"> <i  class="fas fa-sync" ></i> </button> </a>
                      </td>
                    </tr> 
                    <?php } ?> 
                  </tbody>
