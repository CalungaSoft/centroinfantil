                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>  
                      ...
                      <th>Status</th> 
                      <th>Qtd. de Falta</th> 
                      <th title="Justificar Falta">Justificar</th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php
                        $lista=mysqli_query($conexao, "select alunos.nomecompleto, matriculas.* from matriculas, alunos where matriculas.idaluno=alunos.idaluno and matriculas.idanolectivo='$idanolectivo'"); 

                         while($exibir = $lista->fetch_array()){

                          $idmatricula=$exibir["idmatricula"];

                           $quantidadedefalta=mysqli_num_rows(mysqli_query($conexao,"SELECT idfalta from  faltas where  faltas.idmatricula='$idmatricula' and (falta='f' or falta='F') ")); 
                  ...
                  ?>
                    <tr>  
                      ...
                      <td align="center" title="Justificar Falta deste aluno">

                        <?php if($quantidadedefalta!=0){ ?>

                         <a  href="justificarfaltasindividual.php?idmatricula=<?php echo $exibir["idmatricula"]; ?>"> <button class="btn btn-info"> <i  class="fas fa-print" ></i> <sup><i  class="fas fa-trash" ></i></sup></button> </a>
