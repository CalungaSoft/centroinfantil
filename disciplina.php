...
if(isset($_POST['editardadosdadisciplina'])){
      ...
      if(mysqli_num_rows(mysqli_query($conexao," SELECT * FROM disciplinas where titulo='$titulo' and idturma='$idturma' and iddisciplina!='$iddisciplina'"))==0){ 
        ...
        $salvar=mysqli_query($conexao,"UPDATE `disciplinas` SET `titulo` = '$titulo', `abreviatura` = '$abreviatura',`tipodedisciplina` = '$tipodedisciplina',`agrupamento` = '$agrupamento',`idprofessor` = '$idprofessor',`idprofessorauxiliar` = '$idprofessorauxiliar',`obs` = '$obs' WHERE `disciplinas`.`iddisciplina` = '$iddisciplina'");
                      ...
                      <div class="col-sm-3">   
                        ...
                        <span>Tipo de Disciplina</span>
                                  <select name="tipodedisciplina" required  class="form-control">
                                    <option value="Normal" '; if($dadosdadisciplina["tipodedisciplina"]=="Normal") { $htm.='selected="" '; } $htm.='>Normal</option> 
                                    <option value="Chave" '; if($dadosdadisciplina["tipodedisciplina"]=="Chave") { $htm.='selected="" '; } $htm.='>Chave</option> 
                                  </select> 
                        </div> 
                         ...
                         <div class="col-sm-5">  
                          ...
                          <select name="agrupamento" required  class="form-control">
                            <option value="Formação Geral" '; if($dadosdadisciplina["agrupamento"]=="Formação Geral") { $htm.='selected="" '; } $htm.='>Formação Geral</option> 
                            <option value="Formação Específica" '; if($dadosdadisciplina["agrupamento"]=="Formação Específica") { $htm.='selected="" '; } $htm.='>Formação Específica</option> 
                             <option value="Opção" '; if($dadosdadisciplina["agrupamento"]=="Opção") { $htm.='selected="" '; } $htm.='>Opção</option> 
                          </select> 
                        </div> 
                                  ...
                                  ';
                                   ...
                                   $lista=mysqli_query($conexao, "select nomedofuncionario, idfuncionario from funcionarios");
                                    while($exibir = $lista->fetch_array()){
                                     $htm.='
                                    <option '; if($dadosdadisciplina["idprofessor"]==$exibir["idfuncionario"]) { $htm.='selected="" '; } $htm.=' value="'.$exibir["idfuncionario"].'">'.$exibir["nomedofuncionario"].'</option>
                                    ';}  
                                    $htm.='
                                  </select> 
                        </div>
                        ...
                        <span>Professor Auxiliar</span>
                                  ...
                                  ';
                                   ...
                                   $lista=mysqli_query($conexao, "select nomedofuncionario, idfuncionario from funcionarios");
                                    while($exibir = $lista->fetch_array()){
                                     $htm.='
                                    <option  '; if($dadosdadisciplina["idprofessorauxiliar"]==$exibir["idfuncionario"]) { $htm.='selected="" '; } $htm.=' value="'.$exibir["idfuncionario"].'">'.$exibir["nomedofuncionario"].'</option>
                                    ';}  
                                    $htm.='
                                  </select> 
                        </div> 
              ...
              <div class="card shadow mb-4">
                ...
                <div class="collapse in" id="collapseCardExample2">
                  <div class="card-body" style="color: red">
                                 ...
                                 <?php } else{ echo "<br>Você não tem permissão de apagar disciplina, contacte o administrador!"; }?>
                  </div>
                </div>
              </div>
            <!-- Collapsable Card Example -->
            ...
            <script>
                                                            $(document).on("click", "#primeirapergunta", function(event){
                                                             ...
                                                             $(document).on("click", "#minipauta", function(event){
                                                                ...
                                                                var idturma=<?php echo $idturma; ?>;
                                                                    ...
                                                                    method:'POST',
                                                                    data:{
                                                                        iddisciplina, idanolectivo, idturma
                                                                    },
                                                                    success: function(data){
                                                                        $("#resultado").html(data);
                                                            ...
                                                            $(document).on("change", "#idtrimestre", function(event){
                                                              ...
                                                              if(idtrimestre!=0){
                                                                    ...
                                                                    method:'POST',
                                                                    data:{
                                                                        iddisciplina, idtrimestre, idturma,idanolectivo
                                                                    },
                                                                    success: function(data){
                                                                        $("#resultado").html(data);
                                                                  ...
                                                                  $.ajax({
                                                                    ...
                                                                    method:'POST',
                                                                    data:{
                                                                        iddisciplina,  idturma,idanolectivo
                                                                    },
                                                                    success: function(data){
                                                                        $("#resultado").html(data);
