...
$idatl=isset($_GET['idatl'])?$_GET['idatl']:"";
...
if(isset($_POST['editardados_do_atl'])){
  ...
  if(mysqli_num_rows(mysqli_query($conexao," SELECT * FROM atl where titulo='$titulo' and idatl!='$idatl'"))==0){ 
 
    $salvar= mysqli_query($conexao,"UPDATE `atl` SET `titulo` = '$titulo',`descricao` = '$descricao', `propina` = '$propina', `matricula` = '$matricula', `idcoordenador` = '$idcoordenador' WHERE `atl`.`idatl` = '$idatl'");
...
<?php
                  ...
                  $dados_do_atl= mysqli_fetch_array(mysqli_query($conexao, "select * from atl where idatl='$idatl' limit 1")); 
     ...
     ?>
      ...
      <a href="pdf/pdflistadaturmaatl.php?idatl=<?php echo $idatl; ?>" class="d-sm-inline-block btn btn-sm btn-info" ><i class="fas fa-fw fa-print"></i> Imprimir Lista da Turma</a>  <br><br>
          <?php 
            if(!empty($erros)):
          ...
          <div class="col-lg">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Dados do ATL</h6>
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="card border-left-danger shadow h-100 py-2">
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
                                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><a style="text-decoraction:none;" href="atl.php?idatl=<?php echo $dados_do_atl["idatl"] ; ?>">ATL: <?php echo $dados_do_atl["titulo"] ; ?></a></div> <br>
                          ...
                          <?php
                                ...
                                $lista=mysqli_query($conexao, "select * from atl"); 
                        
                          ?>
                      <input type="text" name="titulo" autocomplete="off" list="datalist2" class="form-control"  placeholder="Título para a turma" required="" value="<?php echo $dados_do_atl["titulo"]; ?>">
                    ...
                    <div class="form-group">
                         <span>Descrição</span>
                        <textarea name="descricao" rows="2" class="form-control " title="Descreva o ATL" ><?php echo $dados_do_atl['descricao']; ?></textarea>
                    </div>
                  ...
                  <span>Preço da Matrícula</span>
                          <?php
                                ...
                                $lista=mysqli_query($conexao, "SELECT distinct(matricula) from atl"); 
                       ...
                       <div class="form-group">
                        <span>Propina</span>
                          <?php
                                ...
                                $lista=mysqli_query($conexao, "SELECT distinct(propina) from atl"); 
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                       ...
                                       <?php
                                          ...
                                          $numerodeestudantes=mysqli_num_rows(mysqli_query($conexao, "select idatl FROM matriculaatl where idatl='$idatl'")); 

                                          $numerodematriculas=mysqli_num_rows(mysqli_query($conexao, "select idatl FROM matriculaatl where idatl='$idatl'")); 
            ...
            <div class="card-body"> 
              ...
              <h2>Lista de Alunos</h2>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                  <?php
                        $lista=mysqli_query($conexao, "select alunos.nomecompleto, matriculaatl.* from matriculaatl, alunos where matriculaatl.idaluno=alunos.idaluno and matriculaatl.idatl='$idatl'"); 
