...
$idpropina=mysqli_escape_string($conexao, $idpropina); 

$identrada=mysqli_fetch_array(mysqli_query($conexao," SELECT identrada FROM entradas where tipo='Propina do ATL' and idtipo='$idpropina'"))[0];
 }
                ...
                $salvar_financas=mysqli_query($conexao,"INSERT INTO `entradas` (`identrada`, `idfuncionario`, `descricao`, `tipo`, `idtipo`, `valor`, `divida`, `idaluno`, `idturma`, `datadaentrada`, formadepagamento, idanolectivo) VALUES (NULL, '$idlogado', '$descricao', '$tipo','$idtipo', '$valor', '$nova_divida', '$idaluno', '0', CURRENT_TIMESTAMP, '$formadepagamento', '$idanolectivo')");
                      ...
                      if($salvar_financas){
                        ...
                        $dados_do_pagamento=mysqli_fetch_array(mysqli_query($conexao," SELECT  sum(valor) as totalpago FROM entradas where tipo='$tipo' and idtipo='$idtipo'"));
                          ...
                          $actualizandopagamentos=mysqli_query($conexao,"UPDATE `propinasactividades` SET `valorpago` = '$totalpago' WHERE `propinasactividades`.`idpropina` = '$idtipo'");
            ...
            if($guardar2){
               ...
               $actualizando=mysqli_query($conexao, "UPDATE `entradas` SET `datadaentrada` = '$datadaentrada', `descricao` = '$descricao', `valor` = '$valor', `formadepagamento` = '$formadepagamento' WHERE identrada = '$identrada'");
                  ...
                  $zerando_dividas=mysqli_query($conexao,"UPDATE `entradas` SET  `divida` ='0' WHERE tipo='$tipo' and idtipo='$idtipo'");
                   ...
                   $preco=mysqli_fetch_array(mysqli_query($conexao," SELECT sum(preco-desconto+multa) as preco FROM propinasactividades where idpropina='$idtipo' "))['preco'];
                   ...
                   $actualizando_nasmatriculas=mysqli_query($conexao,"UPDATE `propinasactividades` SET  `valorpago` ='$valorpago' WHERE   idpropina='$idtipo' limit 1");
          ...
          if($nova_divida<0){
              $nova_divida=0;
                          ...
                          if($insirindo_dividas){
                                ...
                                $actualizandopagamentos=mysqli_query($conexao,"UPDATE `propinasactividades` SET `preco` = '$preco', `desconto` = '$desconto', `multa` = '$multa' WHERE `propinasactividades`.`idpropina` = '$idtipo'");
...
<?php
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Detalhes de Pagamento da Propina das actividades extras curriculares | <a href="aluno.php?idaluno=<?php echo "$idaluno";?>"><?php echo "$nomedoaluno";?></a> </h1>
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <p id="mostra1">  <br> <?php
                                                 ...
                                                 $propina_paga=mysqli_fetch_array(mysqli_query($conexao,"SELECT YEAR(mespago) as ano, MONTH(mespago) as mes, propinasactividades.* from propinasactividades where idpropina='$idtipo'"));
            ...
            <script>
                                                            ...
                                                            $(document).on("click", ".deletevenda", function(event){
                                                                ...
                                                                if(confirm("Tens certeza que queres eliminar esse registro? Serão eliminados todos os dados financeiros relacionados com esse registro!")){
                                                                    ...
                                                                    $.ajax({
                                                                    url:'cadastro/deletevendapropinaactividade.php',
                                                                    method:'POST',
                                                                    data:{
                                                                        id:id
                                                                    },
                     ...
                     $(document).on("click", ".delete", function(event){
                                ...
                                if(confirm("Tens certeza que queres eliminar esse registro? Isso não apagará a dívida, pelo contrário só a acrescentará, isso em detrimento do valor pago apagado!")){
                                    $(this).closest('tr').remove(); 
                                    $.ajax({
                                    url:'cadastro/deleteentradapropinaactividade.php',
                                    method:'POST',
                                    data:{
                                        id
                                    },
