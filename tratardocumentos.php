                  ...
                  ?>
                    <tr>  
                      ...
                      <td align="center" title="Tratar Documento desse aluno">
                         <a  href="tratardocumentosindividual.php?idmatriculaeconfirmacao=<?php echo $exibir["idmatriculaeconfirmacao"]; ?>"> <button class="btn btn-success"> <i  class="fas fa-print" ></i></button> </a>
                      </td>
                    </tr> 
                    <?php } ?> 
                  </tbody>
