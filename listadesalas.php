...
if(isset($_POST['cadastrar'])){
  ...
  if(!empty(trim($_POST['titulo']))){ 
      ...
      $titulo=mysqli_escape_string($conexao,$_POST['titulo']); 
        ...
        $existe=mysqli_num_rows(mysqli_query($conexao, "select idsala from salas where titulo='$titulo'"));
      
          if($existe==0){

                $salvar= mysqli_query($conexao,"INSERT INTO `salas` (titulo) VALUES ('$titulo')");
              ...
              $erros[]="Ocorreu um erro Ao Cadastrar a sala";

            } 
          }else{

        $erros[]="Já existe um sala com esse título";
      }
...
include("cabecalho.php") ; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Lista de salas no ano lectivo (<?php echo $anolectivo_escolhido; ?>)</h1>
          <p class="mb-4">A seguir vai a lista de salas disponíveis na instituição</p>
    ...
    <button id="myBtn" class="btn btn-success">  <i class="fas fa-fw fa-plus"></i> Acrescentar uma nova sala</button>
    ...
    <div id="myModal" class="modal"  >
        <div class="modal-content">
          ...
          <form class="user" method="post" action=""> 
                <h3>Cadastrando uma nova sala</h3> <br>
                    <div class="form-group">
                          <?php

                                $lista=mysqli_query($conexao, "select * from salas"); 
                        
                          ?>
                      <input type="text" name="titulo" autocomplete="off" list="datalist2" class="form-control"  placeholder="Título para a sala" required="">
                    ...
                    <br>
                       <input type="submit" name="cadastrar" value="Dar abertura a nova sala" class="btn btn-success" style="float: rigth;">
