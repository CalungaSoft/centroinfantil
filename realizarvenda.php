        ...
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            ...
            <p>Descreva no campo abaixo os produtos a serem comprados
              <span style="font-size: 10px">Separe cada produto por uma virgula</span>
            </p>
          ...
          if (tecla == "," || tecla == 'Enter') {
            ...
            $.ajax({
              ...
              success: function(data) {
                ...
                html += v
                var qt = 0;
                html += '</td><td contenteditable class="quantidade" data-row="' + contador + '" id="quantidade' + contador + '" >1</td>'
                html += '<td class="subtotal" id="subtotal' + contador + '">' + v + '</td>'
                html += '<td class="desconto" contenteditable id="desconto' + contador + '" data-row="' + contador + '">0</td>'
                html += '<td class="total" id="total' + contador + '">' + v + '</td>'
                html += '<td contenteditable class="pago" id="pago' + contador + '" data-row="' + contador + '">' + v + '</td>'
