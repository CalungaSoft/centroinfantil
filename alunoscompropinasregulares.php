...
include("cabecalho.php") ; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Alunos com propinas regulares no ano lectivo <a href="anolectivo.php?idanolectivo=<?php echo "$idanolectivo"; ?>"><?php echo "$nomedoanolectivo"; ?></a> <?php  echo " ( $mesescolhido/$anoescolhido )"; ?></h1>
  ...
  <button id="myBtnreclamacoes" class="btn btn-primary" title="Cadastrar uma saida">Escolher outro ano lectivo</button>  <br> 
    ...
    <script>
          ...
          <a href="pdf/propinasregulares.php?idanolectivo=<?php echo $idanolectivo; ?>&anodevenda=<?php echo $anoescolhido; ?>&mesdevenda=<?php echo $mesescolhido; ?>" id="modelodeminipauta" class="d-sm-inline-block btn btn-sm btn-primary"><i class="fas fa-fw fa-print"></i>Imprimir Lista</a> <br><br>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php
                        ...
                        $lista=mysqli_query($conexao, "SELECT alunos.nomecompleto, YEAR(matriculaseconfirmacoes.ultimomespago) as ano, MONTH(matriculaseconfirmacoes.ultimomespago) as mes, matriculaseconfirmacoes.* from matriculaseconfirmacoes, alunos where matriculaseconfirmacoes.idaluno=alunos.idaluno and matriculaseconfirmacoes.idanolectivo='$idanolectivo' and (ultimomespago>='$mes_em_questao' or tipodealuno='Bolseiro')"); 
