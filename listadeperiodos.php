...
if(isset($_POST['cadastrar'])){
  ...
  if(!empty(trim($_POST['titulo']))){ 
      ...
      $titulo=mysqli_escape_string($conexao,$_POST['titulo']); 
        ...
        $existe=mysqli_num_rows(mysqli_query($conexao, "select idperiodo from periodos where titulo='$titulo'"));
      
          if($existe==0){

                $salvar= mysqli_query($conexao,"INSERT INTO `periodos` (titulo) VALUES ('$titulo')");
              ...
              $erros[]="Ocorreu um erro Ao Cadastrar o período";

            } 
          }else{

        $erros[]="Já existe um período com esse título";
      }
...
include("cabecalho.php") ; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Lista de Períodos no ano lectivo (<?php echo $anolectivo_escolhido; ?>)</h1>
          <p class="mb-4">A seguir vai a lista de períodos disponíveis na instituição</p>
 ...
 <button id="myBtn" class="btn btn-success">  <i class="fas fa-fw fa-plus"></i> Acrescentar um novo Período</button>
    ...
    <div id="myModal" class="modal"  >
        <div class="modal-content">
          ...
          <form class="user" method="post" action=""> 
                <h3>Cadastrando um novo período</h3> <br>
                    <div class="form-group">
                          <?php

                                $lista=mysqli_query($conexao, "select * from periodos"); 
                        
                          ?>
                      <input type="text" name="titulo" autocomplete="off" list="datalist2" class="form-control"  placeholder="Título para o período" required="">
                    ...
                    <br>
                       <input type="submit" name="cadastrar" value="Dar abertura ao novo Período" class="btn btn-success" style="float: rigth;">
                  ...
                  ?>
                    <tr>  
                      ...
                      <td align="center" title="Veja mais opções sobre esse período">
                         <a  href="periodo.php?idperiodo=<?php echo $exibir["idperiodo"]; ?>" <?php echo $exibir["idperiodo"]; ?>><i  class="fas fa-eye" ></i> </a>
                      </td>
                    </tr> 
                    <?php } ?> 
                  </tbody>
