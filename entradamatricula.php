                ...
                $salvar_financas=mysqli_query($conexao,"INSERT INTO `entradas` (`identrada`, `idfuncionario`, `descricao`, `tipo`, `idtipo`, `valor`, `divida`, `idaluno`, `idturma`, `datadaentrada`, formadepagamento, idanolectivo) VALUES (NULL, '$idlogado', '$descricao', '$tipo','$idtipo', '$valor', '$nova_divida', '$idaluno', '$idturma', CURRENT_TIMESTAMP, '$formadepagamento', '$idanolectivo')");
                      ...
                      if($salvar_financas){
                        ...
                        $dados_do_pagamento=mysqli_fetch_array(mysqli_query($conexao," SELECT sum(divida) as totaldivida, sum(valor) as totalpago FROM entradas where tipo='$tipo' and idtipo='$idtipo'"));
                          ...
                          $actualizandopagamentos=mysqli_query($conexao,"UPDATE `matriculaseconfirmacoes` SET `valorpago` = '$totalpago' WHERE `matriculaseconfirmacoes`.`idmatriculaeconfirmacao` = '$idtipo'");
...
if(isset($_POST['editaralteracoes'])){
    ...
    $datadaentrada=mysqli_escape_string($conexao, trim($_POST['datadaentrada']) );  
                ...
                $novo="($descricao) | Pago: $valor  | F. Pag: $formadepagamento | $datadaentrada <a href=entradamatricula.php?identrada=$identrada>Clique para ver</a>";
            ...
            if($guardar2){
               ...
               $actualizando=mysqli_query($conexao, "UPDATE `entradas` SET `datadaentrada` = '$datadaentrada', `descricao` = '$descricao', `valor` = '$valor', `formadepagamento` = '$formadepagamento' WHERE identrada = '$identrada'");
                  ...
                  $zerando_dividas=mysqli_query($conexao,"UPDATE `entradas` SET  `divida` ='0' WHERE tipo='$tipo' and idtipo='$idtipo'");
                   ...
                   $actualizando_nasmatriculas=mysqli_query($conexao,"UPDATE `matriculaseconfirmacoes` SET  `valorpago` ='$valorpago' WHERE   idmatriculaeconfirmacao='$idtipo' limit 1");
          ...
          if($nova_divida<0){
              $nova_divida=0;
                          ...
                          if($insirindo_dividas){
                                ...
                                $actualizandopagamentos=mysqli_query($conexao,"UPDATE `matriculaseconfirmacoes` SET `preco` = '$preco', `desconto` = '$desconto' WHERE `matriculaseconfirmacoes`.`idmatriculaeconfirmacao` = '$idtipo'");
...
if(isset($_POST['editardadoslectivos'])){
    ...
    $turmanova=mysqli_escape_string($conexao, trim($_POST['turmanova']));  
                           ...
                           $salvar=mysqli_query($conexao,"UPDATE matriculaseconfirmacoes set idturma='$turmanova', tipodealuno='$tipodealuno', data='$datadamatricula', descontoparapropinas='$descontoparapropinas', obs='$obsmatricula', turma='$turma', sala='$sala', periodo='$periodo', classe='$classe', curso='$curso' where idmatriculaeconfirmacao='$idtipo'");
                               ...
                               $acerto[]="Alterações feitas com sucesso!";
                                     ...
                                     $erros[]="Já existe uma $tipo desse aluno nessa turma";
                                      ...
                                      $salvar=mysqli_query($conexao,"UPDATE matriculaseconfirmacoes set  tipodealuno='$tipodealuno', data='$datadamatricula', descontoparapropinas='$descontoparapropinas', obs='$obsmatricula' where idmatriculaeconfirmacao='$idtipo'");
                               ...
                               $acerto[]="Alterações feitas com sucesso!";
                                     ...
                                     $erros[]="Ocorreu um erro ao alterar o $tipo do aluno";
                                                 ...
                                                 $dadosdamatricula=mysqli_fetch_array(mysqli_query($conexao," SELECT * FROM matriculaseconfirmacoes where idmatriculaeconfirmacao='$idtipo' "));
 ...
 Ano Lectivo
                                          <h3><strong> <?php echo $anolectivo["titulo"]; ?> </strong></h3>
                                            ...
                                            <?php
                                              ...
                                              $matriculasdesseano= mysqli_query($conexao, "select * from matriculaseconfirmacoes where idmatriculaeconfirmacao='$idtipo'");
                                              ...
                                              <div class="collapse in" id="collapseCardExample2">
                                                ...
                                                <form action="" method="post">
                                                 ...
                                                 <span>Turma</span>
                                                      ...
                                                      <select name="turmanova"   required  class="form-control">
                                                          <option value="0">Escolha a Turma</option> 
                                                        <?php
                                                             $lista=mysqli_query($conexao,"SELECT turmas.titulo as turma, turmas.idturma, anoslectivos.titulo  as anolectivo from turmas, anoslectivos where turmas.idanolectivo=anoslectivos.idanolectivo  order by turmas.titulo desc");
                                                            while($exibir = $lista->fetch_array()){ ?>
                                                            <option <?php if($exibir["idturma"]==$idturma){?> selected="" <?php } ?> value="<?php echo $exibir["idturma"]; ?>"><?php echo $exibir["turma"]; ?> | (<?php echo $exibir["anolectivo"]; ?>)</option>
                                                          <?php } ?> 
                                                      </select> 
                                                      </div>
                                                      ...
                                                      <div class="form-group">
                                                       <span>Data da Matrícula/Confirmação</span>
                                          ...
                                          <!-- Collapsable Card Example -->
                                            ...
                                            <br> <br>
                                                      ...
                                                      <select id="tipodematricula" class="form-control"> 
                                                          <option <?php if($dadosdamatricula["tipo"]=="Matrícula"){echo "selected";} ?> value="Matrícula">Matrícula</option> 
                                                          <option <?php if($dadosdamatricula["tipo"]=="Confirmação"){echo "selected";} ?> value="Confirmação">Confirmação</option> 
                                                          <option <?php if($dadosdamatricula["tipo"]=="Rematrícula"){echo "selected";} ?> value="Rematrícula">Rematrícula</option>
            ...
            <script>
                                                            ...
                                                            $(document).on("click", ".deletevenda", function(event){
                                                                ...
                                                                if(confirm("Tens certeza que queres eliminar esse registro? Serão eliminados todos os dados financeiros relacionados com esse registro!")){
                                                                    ...
                                                                    $.ajax({
                                                                    url:'cadastro/deletevendamatricula.php',
                                                                    method:'POST',
                                                                    data:{
                                                                        id:id
                                                                    },
                     ...
                     $(document).on("click", ".delete", function(event){
                                ...
                                if(confirm("Tens certeza que queres eliminar esse registro? Isso não apagará a dívida, pelo contrário só a acrescentará, isso em detrimento do valor pago apagado!")){
                                    $(this).closest('tr').remove(); 
                                    $.ajax({
                                    url:'cadastro/deleteentradamatricula.php',
                                    method:'POST',
                                    data:{
                                        id
                                    },
                       ...
                       $(document).on("change", "#tipodematricula", function(event){
                          ...
                          var tipodematricula=$("#tipodematricula option:selected").val();
                            ...
                            var idmatriculaeconfirmacao=<?php echo $idtipo; ?>;
                          ...
                          if(confirm("Tens certeza de que desejas mudar o tipo de inscrição? Dados financeiros serão também alterados")){
                              ...
                              method:'POST',
                              data:{
                                  tipodematricula, idmatriculaeconfirmacao
                              },
                              success: function(data){
