...
$mesespecifico=isset($_GET['mesespecifico'])?$_GET['mesespecifico']:"";
 ...
 if(isset($_GET['mesespecifico'])){
      ...
      $total_cobrado_semmulta=mysqli_fetch_array(mysqli_query($conexao,"SELECT sum(preco) from propinasdotransporte where idanolectivo='$idanolectivo' and mespago='$mesespecifico'"))[0];

      $total_em_multa=mysqli_fetch_array(mysqli_query($conexao,"SELECT sum(multa) from propinasdotransporte where idanolectivo='$idanolectivo' and mespago='$mesespecifico'"))[0];

      $total_cobrado_commulta=$total_em_multa+$total_cobrado_semmulta;

      $total_em_desconto=mysqli_fetch_array(mysqli_query($conexao,"SELECT sum(desconto) from propinasdotransporte where idanolectivo='$idanolectivo' and mespago='$mesespecifico'"))[0];
      $total_em_valorpago=mysqli_fetch_array(mysqli_query($conexao,"SELECT sum(valorpago) from propinasdotransporte where idanolectivo='$idanolectivo' and mespago='$mesespecifico'"))[0];
      $total_em_divida=mysqli_fetch_array(mysqli_query($conexao,"SELECT sum(preco+multa-desconto-valorpago) from propinasdotransporte where idanolectivo='$idanolectivo' and mespago='$mesespecifico'"))[0];

 }else{


    $total_cobrado_semmulta=mysqli_fetch_array(mysqli_query($conexao,"SELECT sum(preco) from propinasdotransporte where idanolectivo='$idanolectivo'"))[0];

      $total_em_multa=mysqli_fetch_array(mysqli_query($conexao,"SELECT sum(multa) from propinasdotransporte where idanolectivo='$idanolectivo'"))[0];

      $total_cobrado_commulta=$total_em_multa+$total_cobrado_semmulta;

      $total_em_desconto=mysqli_fetch_array(mysqli_query($conexao,"SELECT sum(desconto) from propinasdotransporte where idanolectivo='$idanolectivo'"))[0];
      $total_em_valorpago=mysqli_fetch_array(mysqli_query($conexao,"SELECT sum(valorpago) from propinasdotransporte where idanolectivo='$idanolectivo'"))[0];
      $total_em_divida=mysqli_fetch_array(mysqli_query($conexao,"SELECT sum(preco+multa-desconto-valorpago) from propinasdotransporte where idanolectivo='$idanolectivo'"))[0];
...
include("cabecalho.php") ; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Relatório de Mensalidade do transporte do ano lectivo <a href="anolectivo.php?idanolectivo=<?php echo "$idanolectivo"; ?>"><?php echo "$nomedoanolectivo"; ?></a> <?php if(isset($_GET['mesespecifico'])){ echo "($nomedomes)"; }?> </h1>
                         ...
                         <div class="col-sm-12"> 
                                <span>Mês Específico</span>
                                  <select name="mesespecifico" required  class="form-control"> 
                                    <?php
                                         $lista=mysqli_query($conexao,"SELECT distinct(mespago), YEAR(propinasdotransporte.mespago) as ano, MONTH(propinasdotransporte.mespago) as mes from propinasdotransporte where idanolectivo='$idanolectivo' order by mespago desc");
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php
                         ...
                         if(isset($_GET['mesespecifico'])){
                             ...
                             $lista=mysqli_query($conexao, "SELECT alunos.nomecompleto,  YEAR(propinasdotransporte.mespago) as ano, MONTH(propinasdotransporte.mespago) as mes, matriculatransporte.*, propinasdotransporte.* from matriculatransporte, propinasdotransporte, alunos where matriculatransporte.idaluno=alunos.idaluno and propinasdotransporte.idanolectivo='$idanolectivo' and propinasdotransporte.idmatriculatransporte=matriculatransporte.idmatriculatransporte and mespago='$mesespecifico'");
 
                               }else{

                              $lista=mysqli_query($conexao, "SELECT alunos.nomecompleto,  YEAR(propinasdotransporte.mespago) as ano, MONTH(propinasdotransporte.mespago) as mes, matriculatransporte.*, propinasdotransporte.* from matriculatransporte, propinasdotransporte, alunos where matriculatransporte.idaluno=alunos.idaluno and propinasdotransporte.idanolectivo='$idanolectivo' and propinasdotransporte.idmatriculatransporte=matriculatransporte.idmatriculatransporte");
                  ...
                  ?>
                    <tr>  
                      ...
                      <td align="center" title="Veja mais opções sobre esse curso">
                         <a  href="entradapropinadotransporte.php?idpropinadotransporte=<?php echo $exibir["idpropinadotransporte"]; ?>"><i  class="fas fa-eye" ></i> </a>
                      </td>
