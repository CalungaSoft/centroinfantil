...
if(!isset($_GET['anodevenda'])){  
    ...
    for ($i=1; $i <=12 ; $i++) { 
      ...
      for ($i=1; $i <=12 ; $i++) { 
      $dia[$i]=mysqli_fetch_array( mysqli_query($conexao,"SELECT sum(valor) from entradas where '$anodevenda'=YEAR(datadaentrada)  and  MONTH(datadaentrada)='$i' "))[0];
    }
...
?>
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Entrada no Caixa<?php if(isset($_GET['anodevenda'])){ echo "| $anodevenda"; }?> <?php if(isset($_GET['tipomarcado'])){ echo "($tipomarcado)"; }?>   </h1>
          <h1 style="font-size: 70px; text-align: center">Total de entrada: <?php echo $totaldeentradas; ?>KZ</h1>
...
<?php  include("estilocarde.php"); ?>
    ...
    <div id="myModalreclamacoes" class="modal"  >
        <div class="modal-content">
          ...
          <form action="mesesentrada.php" method="get"> <br>
          Comparando Aquisição de Cliente nos anos:  <br>
...
if(!isset($_GET['anodevenda'])){  
  ...
  $outrosanos=mysqli_fetch_array(mysqli_query($conexao, "select sum(valor) FROM entradas where YEAR(datadaentrada)!='$anodevenda'"))[0]; 
}
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Fluxo de Mensalidades</h6>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="mt-4 text-center small">
                    ...
                    <span class="mr-2">
                      <i class="fas fa-circle text-gray"></i> Entradas Outros Anos
                    </span> 
                  </div>
                </div>
              </div>
...
var myPieChart = new Chart(ctx, {
  type: 'doughnut',
  data: {
    labels: ["Entradas Outros Anos", "Entradas deste ano"],
    datasets: [{
