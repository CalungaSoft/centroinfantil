...
include("cabecalho.php") ; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Lista de Alunos | Rematrícula</h1> <br>
                  ...
                  ?>
                    <tr >  
                      ...
                      <td><?php echo $exibir['morada']; ?></td> 
                       <td align="center" title="Rematricular aluno">
                         <a  href="rematricula.php?idaluno=<?php echo $exibir["idaluno"]; ?>"> <button class="btn btn-success"> <i  class="fas fa-sync" ></i> </button> </a>
                      </td>
                    </tr> 
                    <?php } ?> 
                  </tbody>
