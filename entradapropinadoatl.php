...
$idpropinadoatl=isset($_GET['idpropinadoatl'])?$_GET['idpropinadoatl']:"";
$idpropinadoatl=mysqli_escape_string($conexao, $idpropinadoatl); 

$identrada=mysqli_fetch_array(mysqli_query($conexao," SELECT identrada FROM entradas where tipo='Propina do ATL' and idtipo='$idpropinadoatl'"))[0];
 }
                ...
                $salvar_financas=mysqli_query($conexao,"INSERT INTO `entradas` (`identrada`, `idfuncionario`, `descricao`, `tipo`, `idtipo`, `valor`, `divida`, `idaluno`, `idturma`, `datadaentrada`, formadepagamento, idanolectivo) VALUES (NULL, '$idlogado', '$descricao', '$tipo','$idtipo', '$valor', '$nova_divida', '$idaluno', '0', CURRENT_TIMESTAMP, '$formadepagamento', '$idanolectivo')");
                      ...
                      if($salvar_financas){
                        ...
                        $dados_do_pagamento=mysqli_fetch_array(mysqli_query($conexao," SELECT  sum(valor) as totalpago FROM entradas where tipo='$tipo' and idtipo='$idtipo'"));
                          ...
                          $actualizandopagamentos=mysqli_query($conexao,"UPDATE `propinasdoatl` SET `valorpago` = '$totalpago' WHERE `propinasdoatl`.`idpropinadoatl` = '$idtipo'");
...
if(isset($_POST['editaralteracoes'])){
    ...
    $datadaentrada=mysqli_escape_string($conexao, trim($_POST['datadaentrada']) );  
                ...
                $novo="($descricao) | Pago: $valor  | F. Pag: $formadepagamento | $datadaentrada <a href=entradapropinadoatl.php?identrada=$identrada>Clique para ver</a>";
            ...
            if($guardar2){
               ...
               $actualizando=mysqli_query($conexao, "UPDATE `entradas` SET `datadaentrada` = '$datadaentrada', `descricao` = '$descricao', `valor` = '$valor', `formadepagamento` = '$formadepagamento' WHERE identrada = '$identrada'");
                  ...
                  $zerando_dividas=mysqli_query($conexao,"UPDATE `entradas` SET  `divida` ='0' WHERE tipo='$tipo' and idtipo='$idtipo'");
                   ...
                   $preco=mysqli_fetch_array(mysqli_query($conexao," SELECT sum(preco-desconto+multa) as preco FROM propinasdoatl where idpropinadoatl='$idtipo' "))['preco'];
                   ...
                   $actualizando_nasmatriculas=mysqli_query($conexao,"UPDATE `propinasdoatl` SET  `valorpago` ='$valorpago' WHERE   idpropinadoatl='$idtipo' limit 1");
          ...
          if($nova_divida<0){
              $nova_divida=0;
                          ...
                          if($insirindo_dividas){
                                ...
                                $actualizandopagamentos=mysqli_query($conexao,"UPDATE `propinasdoatl` SET `preco` = '$preco', `desconto` = '$desconto', `multa` = '$multa' WHERE `propinasdoatl`.`idpropinadoatl` = '$idtipo'");
...
<?php
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Detalhes de Pagamento da Propina do ATL| <a href="aluno.php?idaluno=<?php echo "$idaluno";?>"><?php echo "$nomedoaluno";?></a> </h1>
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <p id="mostra1">  <br> <?php
                                                 ...
                                                 $propina_paga=mysqli_fetch_array(mysqli_query($conexao,"SELECT YEAR(mespago) as ano, MONTH(mespago) as mes, propinasdoatl.* from propinasdoatl where idpropinadoatl='$idtipo'"));
            ...
            <script>
                                                            ...
                                                            $(document).on("click", ".deletevenda", function(event){
                                                                ...
                                                                if(confirm("Tens certeza que queres eliminar esse registro? Serão eliminados todos os dados financeiros relacionados com esse registro!")){
                                                                    ...
                                                                    $.ajax({
                                                                    url:'cadastro/deletevendapropinaatl.php',
                                                                    method:'POST',
                                                                    data:{
                                                                        id:id
                                                                    },
                     ...
                     $(document).on("click", ".delete", function(event){
                                ...
                                if(confirm("Tens certeza que queres eliminar esse registro? Isso não apagará a dívida, pelo contrário só a acrescentará, isso em detrimento do valor pago apagado!")){
                                    $(this).closest('tr').remove(); 
                                    $.ajax({
                                    url:'cadastro/deleteentradapropinaatl.php',
                                    method:'POST',
                                    data:{
                                        id
                                    },
