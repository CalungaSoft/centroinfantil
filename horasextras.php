...
include("cabecalho.php") ; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Presença Mensal | <?php echo "$mes";  ?>/<?php echo "$ano";  ?></h1>
        ...
        <div class="modal-content">
          ...
          <form class="user" action="" method="get">
                    <div class="form-group">
                      <select name="ano"  class="form-control" title="Escolha aqui o ano"  >
  ...
  <!-- DataTales Example -->
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                  ...
                  <a href="pdf/pdflistadepresenca.php?mes=<?php echo  $mes; ?>&ano=<?php echo  $ano; ?>" class="d-sm-inline-block btn btn-sm btn-primary" title="Imprimir lista de presença mensal"><i class="fas fa-fw fa-download"></i>Imprimir lista de Horas extras</a>
                  <a href="presenca.php?mes=<?php echo  $mes; ?>&ano=<?php echo  $ano; ?>" class="d-sm-inline-block btn btn-sm btn-primary" title="Ver mapa de presença dos funcionários"><i class="fas fa-fw fa-calendar"></i>Tabela de Presença</a> <br><br>
                   <br><br>
                    ...
                    <tr>
                      ...
                      $data="$i-$mes-$ano";
                        ...
                        $falta=mysqli_fetch_array(mysqli_query($conexao,"SELECT * FROM presenca where idfuncionario='$idfuncionario' and ano='$ano' and dia='$i' and mes='$mes' limit 1")); 
                          $totaldehoras=$totaldehoras+mysqli_fetch_array(mysqli_query($conexao,"SELECT sum(horasextras) FROM presenca where idfuncionario='$idfuncionario' and ano='$ano' and dia='$i' and mes='$mes' limit 1"))[0];
                          $salariototal=$salariototal+$falta["salariopelahorasextras"];
                          $imprimir="$falta[horasextras]";
                          $id=$falta["idfalta"];
                        ...
                        ?>
                          <td  title="<?php echo $exibir['nomedofuncionario']; ?>" class="update" data-id="<?php echo $id; ?>" data-column="<?php echo $idfuncionario; ?>"   style="background-color: <?php echo $cor; ?>;"  <?php if($falta["falta"]=='P'){?>  contenteditable <?php } ?>><strong><?php    echo $imprimir; ?></strong></td>
                      <?php } ?>
                      <td><?php echo $totaldehoras; ?></td> 
                      <td><?php $salariodetodos=$salariodetodos+$salariototal; $n=number_format($salariototal,2,",", "."); echo $n; ?> Kz</td>
                    </tr>
                      <?php } ?>
      ...
      <script>
                                   ...
                                   $(document).on("blur", ".update", function(){
                                        ...
                                        var idfuncionario=$(this).data("column");

                                        var horas=$(this).text(); 
                                        
                                        $.ajax({
                                              url:'cadastro/horasextras.php',
                                              method:'POST',

                                              data:{idfalta, horas, idfuncionario},
