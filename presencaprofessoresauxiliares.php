...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Presença Mensal Dos Professores Auxiliares| <?php echo "$mes_escolhido";  ?>/<?php echo "$ano";  ?></h1>
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <a href="pdf/pdfpresencaprofessoresauxiliares.php?mesdevenda=<?php echo  $mes; ?>&anodevenda=<?php echo  $ano; ?>&idanolectivo=<?php echo  $idanolectivo; ?>" class="d-sm-inline-block btn btn-sm btn-primary" title="Imprimir lista de presença mensal"><i class="fas fa-fw fa-download"></i>Imprimir lista de Presença</a>


        <a href="presencaprofessores.php?mes=<?php echo  $mes; ?>&ano=<?php echo  $ano; ?>&idanolectivo=<?php echo  $idanolectivo; ?>" class="d-sm-inline-block btn btn-sm btn-info"><i class="fas fa-fw fa-eye"></i>Ver Professores Efectivos</a>
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            $listadefuncionários = mysqli_query($conexao, "SELECT  disciplinas.salarioportempoauxiliar,disciplinas.idprofessorauxiliar, disciplinas.titulo, disciplinas.iddisciplina,disciplinas.idturma, funcionarios.nomedofuncionario FROM funcionarios, disciplinas where (funcionarios.idfuncionario=disciplinas.idprofessorauxiliar) and idanolectivo='$idanolectivo'");
            $salariodetodos = 0;
            ...
            ?>
              <tr>
                ...
                <td><?php echo $exibir['salarioportempoauxiliar']; ?></td>
