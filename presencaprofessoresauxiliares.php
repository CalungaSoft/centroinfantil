...
include("cabecalho.php") ; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Presença Mensal Dos Professores Auxiliares| <?php echo "$mes_escolhido";  ?>/<?php echo "$ano";  ?> Total a Pagar <?php echo "$total_a_pagar_professores";  ?> KZ</h1>
  ...
  <!-- DataTales Example -->
                ...
                <thead>
                    <tr> 
                      ...
                      <?php 
                         ...
                         $salario_portempo=mysqli_fetch_array(mysqli_query($conexao,"SELECT salarioportempoauxiliar FROM anoslectivos where idanolectivo='$idanolectivo'"))[0]; 
                  ...
                  $listadefuncionários=mysqli_query($conexao,"SELECT  disciplinas.idprofessorauxiliar, disciplinas.titulo, disciplinas.iddisciplina, funcionarios.nomedofuncionario FROM funcionarios, disciplinas where (funcionarios.idfuncionario=disciplinas.idprofessorauxiliar) and idanolectivo='$idanolectivo'");
                  $salariodetodos=0; 
                   while($exibir = $listadefuncionários->fetch_array()){ 
                    ...
                    <tr>
                      ...
                      <td  ><?php $salariodetodos+=$salariototal; $n=number_format($salariototal,2,",", "."); echo $n; ?> Kz</td>
                    </tr>
                      <?php } ?>
      ...
      <script>
                                   ...
                                   $(document).on("blur", ".update", function(){
                                        ...
                                        var salario_portempo=<?php echo $salario_portempo; ?>;  
