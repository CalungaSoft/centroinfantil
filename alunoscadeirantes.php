...
include("cabecalho.php") ; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Lista de Alunos Com Cadeiras em Atraso (<?php echo $anolectivo_escolhido; ?>)</h1> <br>
                  ...
                  ?>
                     <tr>  
                      ...
                      <td align="center" title="Mudar nota dessa cadeira para poder elimina-la">
                         <a  href="lancarnotapauta.php?iddisciplina=<?php echo $exibir["iddisciplina"]; ?>&eliminar=cadeira"> <button class="btn btn-success"> <i  class="fas fa-sync" ></i> </button> </a>
                      </td>
                    </tr> 
                    <?php } ?> 
                  </tbody>
