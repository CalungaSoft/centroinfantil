...
if(isset($_POST['cadastrar'])){
  ...
  $dividaprecedente=mysqli_escape_string($conexao, trim($_POST['dividaprecedente'])); 
 ...
 $numero_de_processo=mysqli_fetch_array(mysqli_query($conexao, "select numerodeprocesso from alunos order by numerodeprocesso desc limit 1"))[0]+1;
          ...
          $alterando_numero_de_processo=mysqli_query($conexao, "UPDATE `alunos` SET `numerodeprocesso` = '$numero_de_processo' WHERE `alunos`.`idaluno` = '$idaluno' and numerodeprocesso=0");
                ...
                if ($dividaprecedente!=0) {

                  $descricao="Dívida Precedente";
                  
                  $salvar_financas=mysqli_query($conexao,"INSERT INTO `entradas` (`identrada`, `idfuncionario`, `descricao`, `tipo`, `idtipo`, `valor`, `divida`, `idaluno`, `idturma`, `datadaentrada`, formadepagamento, idanolectivo) VALUES (NULL, '$idlogado', '$descricao', 'Inserção no Sistema','$idaluno', 0, '$dividaprecedente', '$idaluno', 0, CURRENT_TIMESTAMP, '', 0)");
                      ...
                      $acerto[]="Aluno(a) $nomecompleto cadastrado com sucesso!";
                ...
                <div class="card-body">
                 <form class="user" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="anodeentrada" class="form-control"   placeholder="Ano em que entrou na instituição" value="2017">
                    </div>


                    <div class="form-group"> 
                      <span>Dívida Antiga</span>
                      <input type="number" name="dividaprecedente" step="any" class="form-control"   placeholder="Dívidas Precedentes" value="0">
                    </div>
