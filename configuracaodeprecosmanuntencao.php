...
if(isset($_POST['editadados'])){
    ...
    $guardar=mysqli_query($conexao,"UPDATE `dadosdaempresa` SET `nomedodireitor` = '$nomedodireitor',`site` = '$site', `nome` = '$nome', `servicos` = '$servicos', `numerodecontribuinte` = '$numerodecontribuinte', `contabancaria` = '$contabancaria', `email` = '$email', `localizacao` = '$localizacao', `telefone` = '$telefone' WHERE `dadosdaempresa`.`iddadosdaempresa` = 1");
...
<h1 class="h3 mb-4 text-gray-800">Configurações</h1>
 ...
 ?>
                    ...
                    <strong>Web Site</strong>: <?php echo $dadosdaempresa["site"]; ?><br> <br>
