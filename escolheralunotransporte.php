...
include("cabecalho.php") ; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Lista de Alunos (Matriculando no Transporte)</h1> <br>
                    ...
                    <tr >  
                      ...
                      <td><?php echo $exibir['morada']; ?></td> 
                       <td align="center" title="Cadastrar aluno no ATL">
                         <a  href="matriculatransporte.php?&idaluno=<?php echo $exibir["idaluno"]; ?>"> <button class="btn btn-success">  <i  class="fas fa-plus" ></i> </button> </a>
                      </td>
                    </tr> 
                    <?php } ?> 
                  </tbody>
