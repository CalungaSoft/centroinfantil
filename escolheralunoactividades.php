...
include("cabecalho.php") ; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Lista de Alunos (Matriculando nas Actividades extras curriculares)</h1> <br>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>  
                      ...
                      <th>Telefone</th>  
                      <th>Morada</th> 
                      <th title="Matricular aluno no ATL">Matricular</th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php
                  ...
                  ?>
                    <tr >  
                      ...
                      <td><?php echo $exibir['morada']; ?></td> 
                       <td align="center" title="Cadastrar aluno no ATL">
                         <a  href="matriculaactividades.php?&idaluno=<?php echo $exibir["idaluno"]; ?>"> <button class="btn btn-success">  <i  class="fas fa-plus" ></i> </button> </a>
                      </td>
                    </tr> 
                    <?php } ?> 
                  </tbody>
