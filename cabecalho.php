    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
          ...
          <div id="calendaria2" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <?php if ($painellogado != "professor") { ?>
                ...
                <a class="collapse-item" href="turmasareapedagogica.php?idanolectivo=<?php echo $anolectivo_cabecalho['idanolectivo']; ?>&funcao=Avaliar Aluno">Avaliar os alunos</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities55" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded"> 
            <a class="collapse-item" href="sessoesdeavaliacao.php">Sessões de avaliações</a>
        ...
        <li class="nav-item">
          ...
          <div id="extra" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="pagarpropinaactividades.php?idanolectivo=<?php echo $anolectivo_cabecalho['idanolectivo']; ?>" title="">Pagar Mensalidade</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="upload/<?php echo $dadospessoais["caminhodafoto"] ?>" alt="">
              </a>
