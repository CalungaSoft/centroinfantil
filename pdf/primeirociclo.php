      ...
      $mes="Dezembro"; 
        ...
        <img src='img/insignia.jpg' >
            ...
            ".$dadosdaempresa['servicos']."<br>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp; ".$dirmunicipal."
                    <p id=texto>
                    &nbsp;&nbsp;&nbsp;a)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	".$frase.", certifico que <a id=nome><u>  ".$dadosdo_aluno['nomecompleto']."</u> </a>, filho (a) de <u>".$dadosdo_aluno['nomedopai']."</u>  e de <u>".$dadosdo_aluno['nomedamae']."</u>, natural de <u>".$dadosdo_aluno['naturalidade']."</u>, Província de <u>".$dadosdo_aluno['provincia']."</u>, portador do B.I nº <u>".$dadosdo_aluno['numerodobioucedula']."</u>, passado pelo Arquivo de Identificação de <u>".$dadosdo_aluno['arquivodeidentificacao']."</u>  zxzxzxzxzxzxzxzxzxzxzxzxzxzxzxzzxzxzxzxzxz  <br>  Concluiu no ano lectivo de <strong>".$anolectivo_12."</strong>  o <strong> I CICLO DO ENSINO SECUNDÁRIO GERAL </strong>, conforme o disposto na alínea b) do artigo 109.º da LBSEE 17/16, de 7 de Outubro.  </p>
          ...
          <table style='border:0px solid; border-spacing:0px; margin-top:-5px;  padding:0px' width='100%' align=center>
                      <tr>
                            ...
                            <td width='auto' style='border: 1px solid; border-spacing:0px' align='center'> 7ª (".$anolectivo_10.")</td>
                            <td width='auto' style='border: 1px solid; border-spacing:0px' align='center'> 8ª (".$anolectivo_11.")</td>
                            <td width='auto' style='border: 1px solid; border-spacing:0px' align='center'> 9ª (".$anolectivo_12.")</td>  
