...
$dia=date('d');  
  ...
  <tbody> 
       "; 
           ...
           $lista=mysqli_query($conexao, "select TIMESTAMPDIFF(YEAR,datadenascimento,CURDATE()) as idade, alunos.nomecompleto, alunos.numerodeprocesso, alunos.sexo,  matriculaseconfirmacoes.* from matriculaseconfirmacoes, alunos where matriculaseconfirmacoes.idaluno=alunos.idaluno and matriculaseconfirmacoes.idturma='$idturma' order by alunos.nomecompleto "); 
     ...
     while($exibir = $lista->fetch_array()){
      ...
      $n++;
          ...
          <tr>
              ...
              <td width='auto' style='border: 1px solid; border-spacing:0px' align=center>".$exibir["idade"]." Anos</td> 
         </tr>  
           "; 
          } 
...
___________________________ <br>
    ".$dadosdainstituicao['nomedodireitor']."
       ...
       // $gerador->setPaper('A4', 'landscape');
        ...
        $gerador->stream(
            "listadeturmas".$turma."CalungaSoft.pdf",
            array(
                "attachment" => true
            )
        );
