        ...
        <div>
            <div>
                ...
                <hr><hr>
                    ...
                    <span style="font-size: 15px; margin-left:30px"> Alunos Inactivos| <strong>'.$dadosdoanolectivo["titulo"].'</strong> </span>
            <br> <br>   ';
...
<h2> Lista Nominal </h2>
<hr><hr>
 <table style='border:0px solid; border-spacing:0px; margin-top:-20px;  padding:20px' width='100%' >
    <thead> 
    <tr>
      ...
      <th  width='auto' style='border: 1px solid; border-spacing:0px'>Motivo</th>
  ...
  <tbody> 
       "; 
           ...
           $lista=mysqli_query($conexao, "select  alunos.nomecompleto,   matriculaseconfirmacoes.classe, matriculaseconfirmacoes.curso, descadastrados.* from matriculaseconfirmacoes, alunos, descadastrados where matriculaseconfirmacoes.idaluno=alunos.idaluno and matriculaseconfirmacoes.idmatriculaeconfirmacao=descadastrados.idmatriculaeconfirmacao order by alunos.nomecompleto "); 
...
___________________________ <br>
  ...
  $gerador->load_html($htm); 
        ...
        $gerador->stream(
            "Alunos Inactivos - CalungaSOFT.pdf",
            array(
                "attachment" => true
            )
        );
