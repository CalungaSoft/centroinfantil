   ...
   $dia=date('d');  
           ...
           <div>
               <div>
                   ...
                   <hr><hr>
                       ...
                       <span style="font-size: 15px; margin-left:30px"> LISTA NOMINAL DOS ALUNOS DO Transporte  <strong>'.$anolectivo.'</strong> </span>
               <br> <br>   ';
       ...
       <tr>
         ...
         <th  width='auto' style='border: 1px solid; border-spacing:0px' align=center>Transporte</th> 
        ...
        while($exibir = $lista->fetch_array()){
         ...
         $n++;
             ...
             <tr>
                 ...
                 <td width='auto' style='border: 1px solid; border-spacing:0px' >".$exibir["transporte"]."</td> 
