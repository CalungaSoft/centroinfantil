      ...
      $mes="Dezembro"; 
        ...
        <img src='img/insignia.jpg' >
          ...
          <table style='border:0px solid; border-spacing:0px; margin-top:-5px;  padding:0px' width='100%' align=center>
                      ...
                      <tr>
                            <td width='auto' style='border: 1px solid; border-spacing:0px' align='center'> 2ª (".$anolectivo_10.")</td>
                            <td width='auto' style='border: 1px solid; border-spacing:0px' align='center'> 4ª (".$anolectivo_11.")</td>
                            <td width='auto' style='border: 1px solid; border-spacing:0px' align='center'> 6ª (".$anolectivo_12.")</td> 
                     </tr>
