    ...
    $dadosdainstituicao=mysqli_fetch_array(mysqli_query($conexao,"select * from dadosdaempresa"));
        ...
        <div>
            <div>
                ...
                <hr><hr>
                    ...
                    <span style="font-size: 15px; margin-left:30px"> |Relatório de Caixa Diário:   '.$diadevenda.' / '.$mesdevenda.' / '.$anodevenda.'</span>
            <br> <br> <br> 
            |Entradas<br>
      ...
      <tbody> 
           ';  
              ...
              $registrosdeentrada=mysqli_query($conexao, "select distinct(tipo) from entradas where '$anodevenda'=YEAR(datadaentrada) AND '$mesdevenda'=MONTH(datadaentrada) AND '$diadevenda'=DAY(datadaentrada) order by datadaentrada asc"); 
...
<br><br>
  ...
  <tbody> 
       "; 
          ...
          $registrosdesaida=mysqli_query($conexao, "select funcionarios.nomedofuncionario,  saidas.* from funcionarios, saidas where funcionarios.idfuncionario=saidas.idfuncionario and  '$anodevenda'=YEAR(datadasaida) AND '$mesdevenda'=MONTH(datadasaida) AND '$diadevenda'=DAY(datadasaida) order by datadasaida asc"); 
...
$total=number_format($total,2,",", ".");  
  ...
  $htm.="
             ...
             <br>
Hoje houve um total de Entrada de ".$totalentradas." KZ e um total de saída de ".$totalsaida." KZ. <br>
Tendo um saldo Mensal de ".$total." KZ. <br>
        ...
        $gerador->stream(
            "relatoriodiario - ".$diadevenda."  de   ".$mesdevenda."  de  ".$anodevenda." -  CalungaSoft.pdf",
            array(
                "attachment" => true
            )
        );
