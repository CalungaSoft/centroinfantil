        ...
        <div>
            <div>
                ...
                <hr><hr>
                    ...
                    <span style="font-size: 24px; margin-left:50px"> Minipauta De '.$nome_da_disciplina.'  - '.$classe.'   <strong>'.$curso.'</strong>  </span>
            <br> <br>   ';
           ...
           if ($dados_da_turma["eclassedeexame"]!='Sim') {
            ...
            $minipauta.='
               ...
               <thead>';
                 ...
                 $numerodenotas_transicao=mysqli_num_rows(mysqli_query($conexao," SELECT * FROM notasdoano where idanolectivo='$idanolectivo' and  tipodeturma='Transição'  and tipo='normal'"));
                 ...
                 <tr>  
                 <th width="auto" style="border: 1px solid; border-spacing:0px"  rowspan="3" align="center">Proc. Nº</th>
                   <th width="auto" style="border: 1px solid; border-spacing:0px"  rowspan="3" align="center">Nome do Estudante</th>
                 ...
                 $lista_de_trimestre= mysqli_query($conexao, "select * from trimestres where idanolectivo='$idanolectivo' order by posicao asc"); 
                   ...
                   while($exibir = $lista_de_trimestre->fetch_array()){
                     ...
                     $numerodenotas_transicao=mysqli_num_rows(mysqli_query($conexao," SELECT * FROM notasdoano where idtrimestre='$idtrimestre' and  idanolectivo='$idanolectivo' and  tipodeturma='Transição'  and tipo='normal'"));
                   ...
                   <th width="auto" style="border: 1px solid; border-spacing:0px"  align="center" colspan="'.$colSpan_tri.'">'.$exibir["titulo"].'</th> 
                    '; } 
            ...
            $minipauta.='
               ...
               <thead>';
                 ...
                 $numerodenotas_transicao=mysqli_num_rows(mysqli_query($conexao," SELECT * FROM notasdoano where idanolectivo='$idanolectivo' and  tipodeturma='exame'  and tipo='normal'"));
                 ...
                 $lista_de_trimestre= mysqli_query($conexao, "select * from trimestres where idanolectivo='$idanolectivo' order by posicao asc"); 
                   ...
                   while($exibir = $lista_de_trimestre->fetch_array()){
                     ...
                     $numerodenotas_transicao=mysqli_num_rows(mysqli_query($conexao," SELECT * FROM notasdoano where idtrimestre='$idtrimestre' and  idanolectivo='$idanolectivo' and  tipodeturma='exame' and tipo='normal' "));
