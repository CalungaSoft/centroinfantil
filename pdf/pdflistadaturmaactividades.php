   ...
   $idactividade=isset($_GET['idactividade'])?$_GET['idactividade']:"0";
   
       $dados_do_actividades=mysqli_fetch_array(mysqli_query($conexao,"SELECT * from actividades where idactividade='$idactividade'"));
   
       $idanolectivo=$dados_do_actividades["idanolectivo"];
    
       $actividades=$dados_do_actividades["titulo"];
       $descricao=$dados_do_actividades["descricao"];
   ...
   $dia=date('d');  
           ...
           <div>
               <div>
                   ...
                   <hr><hr>
                       ...
                       <span style="font-size: 15px; margin-left:30px"> LISTA NOMINAL DOS ALUNOS DA ACTIVIDADES EXTRAS CURRICULARES  <strong>  '.$actividades.' | '.$anolectivo.' </strong> </span>
                       <br><span style="font-size: 12px; margin-left:30px">  <strong> Descrição </strong> :  '.$descricao.'</span>
               <br> <br>   ';
     ...
     <tbody> 
          "; 
              ...
              $lista=mysqli_query($conexao, "select TIMESTAMPDIFF(YEAR,datadenascimento,CURDATE()) as idade, alunos.nomecompleto, alunos.numerodeprocesso, alunos.sexo,  matriculaactividades.* from matriculaactividades, alunos where matriculaactividades.idaluno=alunos.idaluno and matriculaactividades.idactividade='$idactividade' order by alunos.nomecompleto "); 
   ...
   ___________________________ <br>
       ".$dadosdainstituicao['nomedodireitor']."
          ...
          // $gerador->setPaper('A4', 'landscape');
           ...
           $gerador->stream(
               "listaDosalunosDoactividadesCalungaSoft.pdf",
               array(
                   "attachment" => true
               )
           );
