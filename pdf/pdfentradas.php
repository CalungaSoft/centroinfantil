    ...
    $dadosdainstituicao=mysqli_fetch_array(mysqli_query($conexao,"select * from dadosdaempresa"));
        ...
        <div>
            <div>
                ...
                <hr><hr>
                    ...
                    <span style="font-size: 15px; margin-left:30px"> |Relatório de Entrada: '.$mesdevenda.' / '.$anodevenda.'</span>
            <br> <br> <br> 
        <table style="border:0px solid; border-spacing:0px; margin-top:-20px;  padding:20px" width="95%" align=center>
                  ...
                  <tr>
                    ...
                    <th width="auto" style="border: 1px solid; border-spacing:0px">Nº Factura</th>
                ...
                <tbody> 
                     ';   if(!isset($_GET['mesdevenda'])){
                        $registrosdeentrada=mysqli_query($conexao, "select YEAR(entradas.data) as ano, funcionarios.nomedofuncionario, entradas.* from funcionarios, entradas where funcionarios.idfuncionario=entradas.idfuncionario order by data asc limit 150"); 
                   
                      } else
                    
                      if(isset($_GET['mesdevenda'])){
                        $registrosdeentrada=mysqli_query($conexao, "select YEAR(entradas.data) as ano, funcionarios.nomedofuncionario, entradas.* from funcionarios, entradas where funcionarios.idfuncionario=entradas.idfuncionario and '$anodevenda'=YEAR(data) AND '$mesdevenda'=MONTH(data) order by data asc limit 150"); 
                      }  
                      ...
                      while($exibir = $registrosdeentrada->fetch_array()){
                        ...
                        <td width='auto' style='border: 1px solid; border-spacing:0px'>".$exibir["ano"][2]."".$exibir["ano"][3]."FM_".$exibir["factura"]."</td>
                       ...
                       <td width='auto' style='border: 1px solid; border-spacing:0px'>".$exibir["data"]."</td>  
