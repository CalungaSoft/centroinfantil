 ...
 if(isset($_GET['mesdevenda'])){
        ...
        <div>
            <div>
                ...
                <hr><hr>
                    ...
                    <span style="font-size: 15px; margin-left:30px"> Lista nominal dos <strong> alunos Com Propinas regular </strong>  do mês de <strong>'.$mesdevenda.'/'.$anodevenda.' </strong>    | <strong> Toda instituição </strong> | Ano Lectivo: <strong> '.$anolectivo.' </span>
            <br> <br>   ';
  ...
  <tbody> 
       "; 
        ...
        $lista=mysqli_query($conexao, "SELECT alunos.nomecompleto, YEAR(matriculaseconfirmacoes.ultimomespago) as ano, MONTH(matriculaseconfirmacoes.ultimomespago) as mes, matriculaseconfirmacoes.* from matriculaseconfirmacoes, alunos where matriculaseconfirmacoes.idaluno=alunos.idaluno and matriculaseconfirmacoes.idanolectivo='$idanolectivo' and (ultimomespago='$mes_em_questao' or ultimomespago>'$mes_em_questao' or tipodealuno='Bolseiro')    order by idturma"); 
     ...
     while($exibir = $lista->fetch_array()){
                    ...
                    if($exibir["tipodealuno"]=="Bolseiro"){
...
___________________________ <br>
    ".$dadosdainstituicao['nomedodireitor']."
       ...
       // $gerador->setPaper('A4', 'landscape');
        ...
        $gerador->stream(
            "propinasregularesCalungaSoft.pdf",
            array(
                "attachment" => true
            )
        );
