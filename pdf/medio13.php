<?php
  ...
  session_start();
   ...
   $idturma4=$dadosdodocumentos['classequatro'];
   ...
   $anolectivo_13=mysqli_fetch_array(mysqli_query($conexao, "select anoslectivos.titulo from anoslectivos, turmas where turmas.idanolectivo=anoslectivos.idanolectivo and turmas.idturma='$idturma4'  limit 1"))[0];
 
  


  $dadosda_reconfirmacao=mysqli_fetch_array(mysqli_query($conexao, "select * from matriculaseconfirmacoes where idmatriculaeconfirmacao='$idmatriculaeconfirmacao' and idturma='$idturma4' limit 1"));
        ...
        <img src='img/insignia.jpg' >
          ...
          <table style='border:0px solid; border-spacing:0px; margin-top:-5px;  padding:0px' width='100%' align=center>
                      <tr>
                            ...
                            <td width='auto' style='border: 1px solid; border-spacing:0px' align='center'> 13ª (".$anolectivo_13.")</td> 
                          ...
                          $disciplinas=mysqli_query($conexao, "select iddisciplina, titulo from disciplinas  where (idturma='$idturma1' or idturma='$idturma2' or idturma='$idturma3' or idturma='$idturma4')  order by titulo"); 
                            ...
                            $numerode_disciplinas_diferente=0;
                             ...
                             while($exibir = $disciplinas->fetch_array()){
                                ...
                                if($exibir["titulo"]!=$tipodedisciplina){
                                  ...
                                  $iddisciplina=mysqli_fetch_array(mysqli_query($conexao, "select iddisciplina  from disciplinas  where (idturma='$idturma4') and titulo='$titulo_da_disciplina'"))[0];
                                  ...
                                  if($iddisciplina==NULL){
                                    ...
                                    $dadosda_reconfirmacao=mysqli_fetch_array(mysqli_query($conexao, "select * from matriculaseconfirmacoes where idturma='$idturma4' and idaluno='$idaluno' limit 1"));
                                     ...
                                     $notadaprovaderecurso=mysqli_fetch_array(mysqli_query($conexao," SELECT valordanota FROM notas where idmatriculaeconfirmacao='$idmatriculaeconfirmacao' and  iddisciplina='$iddisciplina' and idtipodenota='$idprovaderecurso'"))[0];
                                       ...
                                       if($notadaprovaderecurso!=''){
                                          $nota_final13=$notadaprovaderecurso;
                                        }else{

                                           $nota_final13=round((($dadosdoanolectivo["percentagemdamediadostrimestres"]*$mediadostrimestres)+($notadaprovadeescola*$percentagemrestante)), $arredondarmedia_anolectivo);  
                                        }

                                        $somanota_disc+=1;

                                          if ($nota_final13<$minimoparapositiva) {
                                           $cor_nota13="nome";
                                            }else{
                                              $cor_nota13="";
                                            }
                                     ...
                                     $media_por_disciplina=round((($nota_final10+$nota_final11+$nota_final12+$nota_final13)/$somanota_disc), 2);
                     ...
                     <td width='auto' id='".$color13."' style='border: 1px solid; border-spacing:0px'> <t id='".$cor_nota13."'>".$nota_final13." </t> </td>
