    ...
    $dadosdainstituicao=mysqli_fetch_array(mysqli_query($conexao,"select * from dadosdaempresa"));
        ...
        <div>
            <div> 
                ...
                <span style="font-size: 20px; margin-left:50px"> Mapa de aproveitamento Qualitativo Da  - '.$classe.'  </strong> <strong>'.$curso.'</strong>   |   <strong>'.$nomedotrimestre.' Trimestre</span>
        <br> <br> ';
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
  ...
  <tr>
      ...
      <th width="auto" style="border: 1px solid; border-spacing:0px">MAU</th> 
      <th width="auto" style="border: 1px solid; border-spacing:0px">MED</th> 
      <th width="auto" style="border: 1px solid; border-spacing:0px">SUF</th>
      <th width="auto" style="border: 1px solid; border-spacing:0px">BOM</th>
      <th width="auto" style="border: 1px solid; border-spacing:0px">M. BOM</th> 
    </tr> 
  </thead> 
  <tbody>';
  ...
  $muitobom=0;
    ...
    $tipodedisciplina=$exibir_disciplina['tipodedisciplina'];
            ...
            <tr>
              ...
              <td width="auto" style="border: 1px solid; border-spacing:0px">'.$mau.'</td>  
              <td width="auto" style="border: 1px solid; border-spacing:0px">'.$mediucre.'</td> 
              <td width="auto" style="border: 1px solid; border-spacing:0px">'.$suficiente.'</td> 
              <td width="auto" style="border: 1px solid; border-spacing:0px">'.$bom.'</td> 
              <td width="auto" style="border: 1px solid; border-spacing:0px">'.$muitobom.'</td> 
   ...
   <tfoot>
            <tr>
              ...
              <th width="auto" style="border: 1px solid; border-spacing:0px">'.$matriculados.'</th> 
              <th width="auto" style="border: 1px solid; border-spacing:0px">'.$desistentes.'</th> 
              <th width="auto" style="border: 1px solid; border-spacing:0px">'.$maior_avalidado.'</th> 
